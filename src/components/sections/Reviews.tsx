...
const demoReviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Outstanding service and incredible results. The team at Marzelet went above and beyond to deliver a solution that perfectly matched our needs.',
  ...
  const fetchReviews = async () => {
    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        // Use demo data if no reviews found
        setReviews(demoReviews);
      }
    } catch (error) {
    ...
    <section id="reviews" className="py-24 bg-gray-800">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
            ...
            {!isSupabaseConfigured && (
              <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg max-w-2xl mx-auto">
                <p className="text-yellow-400 text-sm">
                  <strong>Demo Mode:</strong> Connect to Supabase to enable live reviews functionality.
                </p>
              </div>
            )}
          </motion.div>
          ...
          {/* Add Review Form */}
          {showAddReview && user && isSupabaseConfigured && (
            <motion.div
